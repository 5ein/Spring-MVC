...
public class WekaTitanicService {
	...
	public String[] ml(double[] values) throws Exception {
		...
		//String path = "\\Users\\administrator\\Documents\\workspace-spring-tool-suite-4-4.12.1.RELEASE\\wekaProject2";
		//String file = path + "\\data\\titanic2_pre.csv";
		String path2 = "C:\\Users\\LG\\Documents\\workspace-sts-3.9.14.RELEASE\\spring905_AIweka";
		String file2 = path2 + "/data/titanic2_pre.csv";
		//Users/administrator/Documents/workspace-spring-tool-suite-4-4.12.1.RELEASE/wekaProject2/data/titanic2_pre.csv
		//Users\administrator\Documents\workspace-spring-tool-suite-4-4.12.1.RELEASE\wekaProject2\data\titanic2_pre.csv
		...
		Classifier model = (Classifier) SerializationHelper.read(path2 + "/model/titanic_rf.model");
